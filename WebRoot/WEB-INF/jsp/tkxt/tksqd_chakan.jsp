	...
	<div style="width:90%">
		<form id="fm" method="post" name="fm" action="chakan">
			<table cellpadding="5">
				...
				<tr>
					<td>项目名称:</td>
					<td><input type="hidden" name="tksqd.id" value="${tksqd.id }"
						readOnly></input> <input class="easyui-textbox" type="text"
						name="tksqd.xmmc" value="${tksqd.xmmc}"
						data-options="required:true" readOnly></input></td>
					<td>申请人:</td>
					<td><input class="easyui-textbox" type="text" name="tksqd.sqr"
						value="${tksqd.sqr}" data-options="required:true" readOnly></input></td>
					<td>勘察单位:</td>
				...
				<tr>
					<td>勘查矿种:</td>
					<td><input class="easyui-textbox" type="text"
						name="tksqd.kckz" value="${tksqd.kckz}"
						data-options="required:true" readOnly></input></td>
					<td>项目性质:</td>
					<td><input class="easyui-textbox" type="text"
						name="tksqd.xmxz" value="${tksqd.xmxz}"
						data-options="required:true" readOnly></input></td>
					<td>总面积:</td>
					<td><input class="easyui-textbox" type="text" name="tksqd.zmj"
						value="${tksqd.zmj}" data-options="required:true" readOnly></input></td>
				</tr>
				<tr>
					<td>资金:</td>
					<td><input class="easyui-textbox" type="text" name="tksqd.zj"
						value="${tksqd.zj}" data-options="required:true" readOnly></input></td>
					<td>法定代表人:</td>
					<td><input class="easyui-textbox" type="text"
						name="tksqd.fddbr" value="${tksqd.fddbr}"
						data-options="required:true" readOnly></input></td>
					<td>电话:</td>
					<td><input class="easyui-textbox" type="text" name="tksqd.dh"
						value="${tksqd.dh}" data-options="required:true" readOnly></input></td>
				</tr>
				<tr>
					<td>工作任务及主要目的:</td>
					<td colspan=5><textarea rows="10" cols="50"
							name="tksqd.gzrwjzymd" readOnly>${tksqd.gzrwjzymd}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
