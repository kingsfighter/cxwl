...
<body>
	...
	<table id="tt" class="easyui-datagrid" style="width:80%;height:auto;"
		url="/user/list" toolbar="#tb" rownumbers="true" pagination="true">
		<thead>
			<tr>
	...
	<div id="tb">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="javascript:showFormPage('新增用户','add','/user/showAddView')">增加</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true"
			onclick="javascript:showFormPage('修改用户','edit','/user/showEditView')">修改</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-cut" plain="true"
			onclick="javascript:deleteRecord('/user/delete')">删除</a>
	</div>
